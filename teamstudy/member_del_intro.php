				...
				<!-- Main -->
					<section id="main" class="wrapper">
						<div class="inner">
							...
							<h1 class="major">회원탈퇴</h1>
						</div>
					</section>
			</div>				
			<div class="check" style="text-align:center">
            <form method="post" action="member_del_page.php">
				<img src="images/delete.png" height="100px">
				<label style="margin-top:10px; font-size:20px; font-weight: bold;">PICKUP 스터디카페 서비스 회원을 탈퇴하시려면 비밀번호를 입력하셔야 합니다.</label>
